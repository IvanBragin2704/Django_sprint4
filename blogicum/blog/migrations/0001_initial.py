# Generated by Django 3.2.16 on 2025-12-15 13:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='Идентификатор страницы для URL; разрешены символы латиницы, '
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Публикация', to='blog.post', verbose_name='comments')),
            ],
            options={
